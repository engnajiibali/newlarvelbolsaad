                     ...
                     <div class="noti-content">
                        <div class="d-flex flex-column">
                              ...
                              <a href="activity.html">
                                 <div class="d-flex">
                                    <span class="avatar avatar-lg me-2 flex-shrink-0">
                                       <img src="{{asset('resources/views/assets/img/profiles/avatar-27.jpg')}} " alt="Profile">
                                    </span>
                           ...
                           <div class="border-bottom mb-3 pb-3">
                              <a href="activity.html" class="pb-0">
                                 <div class="d-flex">
                                    <span class="avatar avatar-lg me-2 flex-shrink-0">
                                       <img src="{{asset('resources/views/assets/img/profiles/avatar-23.jpg')}} " alt="Profile">
                                    </span>
                                    <div class="flex-grow-1">
                                       <p class="mb-1"><span
                        ...
                        <div class="border-bottom mb-3 pb-3">
                           <a href="activity.html">
                              <div class="d-flex">
                                 <span class="avatar avatar-lg me-2 flex-shrink-0">
                                    <img src="{{asset('resources/views/assets/img/profiles/avatar-25.jpg')}}  " alt="Profile">
                                 </span>
                                 <div class="flex-grow-1">
                        ...
                        <div class="border-0 mb-3 pb-0">
                           <a href="activity.html">
                              <div class="d-flex">
                                 <span class="avatar avatar-lg me-2 flex-shrink-0">
                                    <img src="{{asset('resources/views/assets/img/profiles/avatar-01.jpg')}} " alt="Profile">
                                 </span>
                                 <div class="flex-grow-1">
            ...
            <div class="dropdown profile-dropdown">
               <a href="javascript:void(0);" class="dropdown-toggle d-flex align-items-center" data-bs-toggle="dropdown">
                  <span class="avatar avatar-sm online">
                     <img src="{{asset('public/upload/'.Session()->get('photo'))}}" alt="Img" class="img-fluid rounded-circle">
                  </span>
               </a>
                     ...
                     <div class="card-header">
                        <div class="d-flex align-items-center">
                           <span class="avatar avatar-lg me-2 avatar-rounded">
                              <img src="{{asset('public/upload/'.Session()->get('photo'))}}" alt="img">
                           </span>
                           <div>
                              <h5 class="mb-0">{{Session()->get('username')}}</h5>
                              <p class="fs-12 fw-medium mb-0">{{Session()->get('email')}}</p>
                           </div>
                        </div>
                     </div>
                     <div class="card-body">
