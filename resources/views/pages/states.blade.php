...
<html>
<head>
    <title>Laravel 12 AJAX CRUD - State</title>
...
<div class="container mt-5">
    <div class="card">
        <h2 class="card-header"><i class="fa-regular fa-map"></i> State Management</h2>
        <div class="card-body">
            <div class="d-grid gap-2 d-md-flex justify-content-md-end mb-3">
                <a class="btn btn-success btn-sm" href="javascript:void(0)" id="createNewState">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="stateForm" name="stateForm" enctype="multipart/form-data">
...
$(function () {
    ...
    $('#createNewState').click(function(){
        ...
        $('#preview-image').hide();
        $('.error-text').text('');
        $('#modelHeading').html("<i class='fa fa-plus'></i> Create State");
    ...
    $('body').on('click', '.editState', function(){
        ...
        $.get("{{ route('States.index') }}/"+id+"/edit", function(data){
            $('#modelHeading').html("<i class='fa fa-edit'></i> Edit State");
    ...
    $('body').on('click', '.deleteState', function(){
        ...
        Swal.fire({
            ...
            if(result.isConfirmed){
                $.ajax({
                    type:'DELETE',
                    url:"{{ route('States.store') }}/"+id,
                    success:function(){ table.draw(); Swal.fire({ icon:'success', title:'Deleted!', text:'State deleted.', timer:2000, showConfirmButton:false }); },
