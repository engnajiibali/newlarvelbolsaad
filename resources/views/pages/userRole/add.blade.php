...
<form id="pForm"  method="post" action="{{route('userRole.store')}}" enctype="multipart/form-data">
    @csrf
@method('post')
...
<div class="col-md-12">
<div class="mb-3">
    <input type="hidden" id="hmenu1" name="menu" class="" value="">
<label class="form-label"> Role Name</label>
<input type="text" class="form-control" name="Role" id="Role" placeholder="Role Name" value="{{old('Role')}}">
...
<textarea class="form-control" placeholder="Enter description..." name="Description" id="dec">{{ old('Description') }}</textarea>
...
<div class="col-md-2">
<label>
<input type="checkbox" name="Read" value="0" class="permission-checkbox"> Show
</label>
</div>
...
<div class="col-md-2">
<label>
<input type="checkbox" name="Write" value="0" class="permission-checkbox"> Write
</label>
</div>
...
<div class="col-md-2">
<label>
<input type="checkbox" name="Edit" value="0" class="permission-checkbox"> Edit
</label>
</div>
...
<div class="col-md-2">
<label>
<input type="checkbox" name="Delete" value="0" class="permission-checkbox"> Delete
</label>
</div>
