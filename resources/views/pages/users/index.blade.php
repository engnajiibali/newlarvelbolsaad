...
@push('styles')
    ...
    <!-- Color Picker -->
    <link rel="stylesheet" href="{{ asset('assets/plugins/@simonwep/pickr/themes/classic.min.css') }}">
@endpush
...
@section('content')
        ...
        <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
            <div class="me-2 mb-2">
                <div class="d-flex align-items-center border bg-white rounded p-1 me-2 icon-list">
                    <a href="{{ url('employees') }}" class="btn btn-icon btn-sm active bg-primary text-white me-1">
    ...
    <div class="row">
        @php
            $cards = [
                ['title' => 'Total Employee', 'count' => 1007, 'icon' => 'ti ti-users', 'bg' => 'bg-dark', 'badge' => 'badge-soft-purple'],
                ['title' => 'Active', 'count' => 1007, 'icon' => 'ti ti-user-share', 'bg' => 'bg-success', 'badge' => 'badge-soft-primary'],
                ['title' => 'InActive', 'count' => 1007, 'icon' => 'ti ti-user-pause', 'bg' => 'bg-danger', 'badge' => 'badge-soft-dark'],
                ['title' => 'New Joiners', 'count' => 67, 'icon' => 'ti ti-user-plus', 'bg' => 'bg-info', 'badge' => 'badge-soft-secondary']
            ];
        @endphp
                ...
                <div class="card flex-fill">
                    <div class="card-body d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center overflow-hidden">
                            <div>
                                <span class="avatar avatar-lg {{ $card['bg'] }} rounded-circle"><i class="{{ $card['icon'] }}"></i></span>
                            </div>
                            <div class="ms-2 overflow-hidden">
                                <p class="fs-12 fw-medium mb-1 text-truncate">{{ $card['title'] }}</p>
                                <h4>{{ $card['count'] }}</h4>
                            </div>
                        </div>
                        <div>
                            <span class="badge {{ $card['badge'] }} badge-sm fw-normal">
            ...
            <div class="d-flex my-xl-auto right-content align-items-center flex-wrap row-gap-3">
                ...
                <div class="dropdown me-3">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end p-3">
                        ...
                        <li><a href="javascript:void(0);" class="dropdown-item rounded-1">Developer</a></li>
                        <li><a href="javascript:void(0);" class="dropdown-item rounded-1">Executive</a></li>
                    </ul>
                </div>
                <!-- Status Dropdown -->
                <div class="dropdown me-3">
                    ...
                    <tbody>
                        ...
                        @for ($i = 1; $i <= 10; $i++)
                            <tr>
                                ...
                                <td><a href="employee-details.html">Emp-00{{ $i }}</a></td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <a href="employee-details.html" class="avatar avatar-md" data-bs-toggle="modal" data-bs-target="#view_details">
                                            <img src="{{ asset('assets/img/users/user-0' . $i . '.jpg') }}" class="img-fluid rounded-circle" alt="img">
                                        </a>
                                        <div class="ms-2">
                                            <p class="text-dark mb-0"><a href="employee-details.html" data-bs-toggle="modal" data-bs-target="#view_details">Employee {{ $i }}</a></p>
                                            <span class="fs-12">Designation</span>
                                        </div>
                                    </div>
                                </td>
