...
<h3 class="account-title text-center">Reset Password</h3>
<p class="account-subtitle text-center">Change your password.</p>
    <form id="pForm" method="post" action="{{ route('change-password') }}" enctype="multipart/form-data">
      @csrf
      @method('post')
<div class="form-group has-feedback">
  <input type="hidden" class="form-control"  id="user_id" name="user_id" placeholder="Password" value="{{$user->id}}">
...
<!-- /.col -->
<div class="col-xs-12">
<button type="submit" class="btn btn-primary btn-block btn-flat" id="changebtn">Submit</button>
</div>
<!-- /.col -->
</div>
</form>
