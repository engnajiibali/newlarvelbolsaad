...
<h3 class="account-title ">Link Exxpired</h3>
<p class="account-subtitle">To reset your password,retunr to the loging page and select Forget PAssword Button to send new email.</p>
  <!-- /.login-box-body -->
  <hr>
