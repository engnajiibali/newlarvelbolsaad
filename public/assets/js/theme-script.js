                        ...
                        <div class="row gx-3">
                                ...
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="defaultLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="{{asset('resources/views/assets/img/theme/default.svg')}} " alt="imgsss">
                                        </span>                                     
                                        <span class="layout-type">Defaultssss</span>
                                    </label>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="miniLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="{{asset('resources/views/assets/img/theme/mini.svg')}} " alt="img">
                                        </span>                                    
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="horizontalLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="{{asset('resources/views/assets/img/theme/horizontal.svg')}} " alt="img">
                                        </span>                                    
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="horizontal-singleLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="{{asset('resources/views/assets/img/theme/horizontal-single.svg')}} " alt="img">
                                        </span>                                    
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="twocolumnLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="{{asset('resources/views/assets/img/theme/two-column.svg')}} " alt="img">
                                        </span>                                    
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="without-headerLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="{{asset('resources/views/assets/img/theme/without-header.svg')}} " alt="img">
                                        </span>                                    
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="horizontal-overlayLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="{{asset('resources/views/assets/img/theme/overlay.svg')}} " alt="img">
                                        </span>                                    
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="horizontal-sidemenuLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="{{asset('resources/views/assets/img/theme/menu-aside.svg')}}  " alt="img">
                                        </span>                                    
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="stackedLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="{{asset('resources/views/assets/img/theme/stacked.svg')}}  " alt="img">
                                        </span>                                    
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="modernLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="{{asset('resources/views/assets/img/theme/modern.svg')}} " alt="img">
                                        </span>                                    
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="transparentLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="{{asset('resources/views/assets/img/theme/transparent.svg')}} " alt="img">
                                        </span>                                    
                            ...
                            <div class="col-4">
                                <a href="layout-rtl.html" class="theme-layout mb-3">
                                    <span class="d-block mb-2 layout-img">
                                        <img src="{{asset('resources/views/assets/img/theme/rtl.svg')}} " alt="img">
                                    </span>                                    
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="borderedCard">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="{{asset('resources/views/assets/img/theme/bordered.svg')}} " alt="img">
                                        </span>                                     
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="borderlessCard">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="{{asset('resources/views/assets/img/theme/borderless.svg')}} " alt="img">
                                        </span>                                    
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="shadowCard">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="{{asset('resources/views/assets/img/theme/shadow.svg')}} " alt="img">
                                        </span>                                    
                       ...
                       <div class="d-flex align-items-center flex-wrap">
                            ...
                            <div class="theme-sidebarbg me-3 mb-3">
                                ...
                                <label for="sidebarBg6" class="d-block rounded">
                                    <img src="{{asset('resources/views/assets/img/theme/sidebar-bg-06.svg')}} " alt="imgdddddddddddd" class="rounded">
                                </label>
                            </div>
                        </div>
                    </div>
